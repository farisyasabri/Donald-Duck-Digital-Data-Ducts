...
public class Statistics {
    ...
    public void mainStatistics() {
        ...
        System.out.println("Does the column contain non-numeric(string) values except header?");
    ...
    public void statsDouble() {
        ...
        System.out.printf("Range: %.2f",range());
        System.out.printf("\nMean: %.2f\n", mean());
        System.out.println("Mode: " + modeDouble());
...
//--------------------------------------------------------------IMPUTERS--------------------------------------------------------------------------------------------------------
    ...
    public void askImputers(){
        Scanner s = new Scanner(System.in);
        System.out.println("Do you want to fill in the missing value? If yes, we will jump into imputation process.");
        System.out.println("1 : YES ");
        System.out.println("2 : NO ");
        int num = s.nextInt();
        if (num==1){
    ...
    public void imputers() {
        ...
        System.out.println("Choose one column to fill in the value.");
