...
public class ErrorMetrics {
    ...
    private double[][] saveData, saveStandardScaling;
    private double[] predicted_valueR, actual_valueR, distance, copyDistance, meanColumn, sd;
    ...
    public void mean(){
        ...
        meanColumn = new double[numOfColumnToRefer];
        ...
        for (int i=0;i<numOfColumnToRefer;i++) {
            System.out.printf("The mean column " + columnToRefer[i] +" is : %.2f\n", meanColumn[i]);
        }
    }
    ...
    public void standardDeviation(){
        ...
        sd = new double[numOfColumnToRefer];
        double upper = 0, total=0, cnt = 0;

        for (int i=0;i<numOfColumnToRefer;i++) {
            for (int j = 0; j < row - 1; j++) //-1
            {
                total = Math.pow((saveData[j][i] - meanColumn[i]), 2);
                upper += total;
                cnt++;
            }
            sd[i] = Math.sqrt(upper/cnt); // standard deviation formula
        }


        for (int j=0;j<numOfColumnToRefer;j++) {
            System.out.printf("The standard deviation column " + columnToRefer[j] +" is : %.2f\n", sd[j]);
        }
        System.out.println();
    ...
    public void standardScaling(){
        ...
        saveStandardScaling = new double[row][numOfColumnToRefer];
        for (int i=0;i<numOfColumnToRefer;i++) {
            for (int j = 0; j < row-1; j++)    //-1
            {
    ...
    public void calculateMSE() {
        ...
        RMSE = Math.sqrt(MSE);
        System.out.printf("Mean Square Error : %.2f\n" , MSE);
        System.out.printf("Root Mean Square Error : %.2f\n" , RMSE);
    ...
    public void calculatePrecisionRecallF1score(){
        ...
        if(truePositive == 0 && trueNegative == 0 && falsePositive == 0 && falseNegative == 0){
            System.out.println("No precision, recall and f1 score calculated for this type of data");
        }
        else {
