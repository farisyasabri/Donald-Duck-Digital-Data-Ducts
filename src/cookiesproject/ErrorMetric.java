...
public class ErrorMetric {
    ...
    private double[] dataForRegression, dataForRegressor;
    ...
    public void mainKNN() {
        ...
        if(choose == 1){
            getdataForRegressor();
            System.out.println("do you want to calculate the error metric?");
            String ans = s.next();
            ...
            for(int i = 0; i < amountofDataUsedforErrorPrediction; i++) {
                ...
                System.out.println("proses ended");
        }
        else{
            for(int i = 0; i < amountofDataUsedforErrorPrediction; i++) {
                row_predicted_value = amountofDataUsedforCalculation + 2 + i;
...
//        writeInFile(Double.toString(regressor));
    ...
    public void EuclideanDistanceForError(){
        ...
        arrangeKnnDistanceForError();
    }
    public void setDistance(double[] distance) {
        this.distance = distance;
    }

    public void arrangeKnnDistanceForError(){
        ...
        getIndexForKnnForError();
    }

    public void getIndexForKnnForError(){
        Index = new int[k+1];
        int  i= 0;
        while(i < k) {
        ...
        arrangeIndexForError();
    }
    public void arrangeIndexForError(){
        ...
        displayGetIndexForError();      // call method to display the index for row | p/s: will be use to get the value for k-nearest distance

    }

    public void displayGetIndexForError(){
